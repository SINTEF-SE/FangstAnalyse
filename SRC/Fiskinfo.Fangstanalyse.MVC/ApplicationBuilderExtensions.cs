...
namespace SintefSecureBoilerplate.MVC
{
    public static partial class ApplicationBuilderExtensions
    {
        ...
        /// <summary>
        /// Adds the Content-Security-Policy (git diff) and/or Content-Security-Policy-Report-Only HTTP headers. This
        ...
        /// Implemented using the NWebsec library; <nwebsec.aspnetcore.middleware>
        /// </summary>
                    ...
                    options
                        ...
                        .ConnectSources(
                            x =>
                            {
                                ...
                                ) // Allow Browser Link to work correctly in Development.
                                {
                        ...
                        // obj-src - This directive specifies valid sources for the <object>, <embed>, and <applet> elements.
                        .ObjectSources(
                        x =>
                        {
                            x.None(); // We disallow everything by default.
                        })
                        .ManifestSources(
                            x =>
                            {
