...
using SintefSecureBoilerplate.MVC.Helpers;
using SintefSecureBoilerplate.MVC.Models;
using SintefSecureBoilerplate.MVC.Models.Authorization;

namespace SintefSecureBoilerplate.MVC.Controllers
{
    // UNDER HERE IS A MORE FUTURE PROOF IMPLEMENTATION, HOWEVER, OPENIDDICT HASNT RELEASED THEIR NEW RC AND FOR MAINTANCE, WE SHOULDNT USE IT.... YET
    ...
    public class AuthorizationController : Controller
    {
        ...
        public async Task<IActionResult> Authorize(OpenIdConnectRequest request)
        {
            ...
            if (application == null)
            {
                return View("OpenIdDictError", new OpenIdDictErrorModel
                {
