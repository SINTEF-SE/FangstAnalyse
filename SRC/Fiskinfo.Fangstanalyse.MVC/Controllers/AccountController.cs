...
using SintefSecureBoilerplate.MVC.Models.Account;
using SintefSecureBoilerplate.MVC.Services.Messages;
...
namespace SintefSecureBoilerplate.MVC.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private readonly IdentityDatabaseContext _applicationDbContext;
        ...
        public AccountController(
            ...
            IdentityDatabaseContext applicationDbContext)
        {
        ...
        {
            return code == null ? View("OpenIdDictError") : View();
        }
        ...
        private static void EnsureDatabaseCreated(IdentityDatabaseContext context)
        {
            if (!_databaseChecked)
            {
